...
\familyname{Costas Piñó} % Your last name

% All information in this block is optional, comment out any lines you don't need
\title{Curriculum Vitae, updated \today}
\address{Calle Albari\~{n}o, 24, 2$^\circ$}{36630 - Cambados (Galicia) - Spain}
\mobile{(+34)~660~784~672}
\email{miguel.costas@udc.es}
\extrainfo{Birth date: 11.28.1987} 
\photo[64pt][0pt]{pictures/foto_yo} % The first bracket is the picture height, the second is the thickness of the frame around the picture (0pt for no frame)
